...
function SecondaryProjectCard({
  ...
  return (
    <article
      className={`group relative overflow-hidden rounded-2xl border bg-card/50 p-6 transition-all duration-300 hover:border-border/80 hover:shadow-lg hover:shadow-black/20 ${accentBorder}`}
    >
